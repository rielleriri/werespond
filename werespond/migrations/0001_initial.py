# Generated by Django 3.0.4 on 2020-03-18 01:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_type', models.CharField(choices=[('c', 'Cardiac Arrest'), ('f', 'Fire Case'), ('h', 'Fire Hazard')], max_length=1, verbose_name='Case Type')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cert_type', models.CharField(max_length=100, verbose_name='Cert Type')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('correct', models.BooleanField(verbose_name='Correct Ans')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('awarded', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='werespond.Post')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='werespond.User')),
            ],
            options={
                'ordering': ('id',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('response', models.BooleanField(default=False, verbose_name='Did User Respond?')),
                ('arrival_time', models.DateField(verbose_name='User Responded At')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('c', 'Cardiac Arrest'), ('f', 'Fire Report')], max_length=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='werespond.User')),
            ],
            options={
                'ordering': ('id',),
        ...
        migrations.AddField(
            model_name='case',
            name='users',
            field=models.ManyToManyField(blank=True, related_name='cases', through='werespond.Response', to='werespond.User'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(blank=True, related_name='achievements', through='werespond.AchievementProgress', to='werespond.User'),
        ),
    ]
